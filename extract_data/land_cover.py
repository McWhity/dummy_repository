...
path = '/media/tweiss/Daten/clc5_2018.utm32s.shape/clc5/'
name_shp = 'clc5_class2xx.shp'
name = 'clc5_class2xx_2018.tif'


subprocess.call('gdal_rasterize -at -of GTiff -a CLC18 -te 695047 5346800 703600 5354600 -tr 10 10 -ot Byte -co \"COMPRESS=DEFLATE\" '+path+name_shp+' '+path+name, shell=True)
